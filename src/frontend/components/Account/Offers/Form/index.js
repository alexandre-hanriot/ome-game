  ...
  <div className="wrapper account-offers-form">
    ...
    <div className="account-offers-form__container">
      <div className="account-offers-form__container__left">
        <input type="text" placeholder="Nom de l'offre" className="account-offers-form__field" />

        <h2 className="account-offers-form__subtitle">Jeu</h2>

        <input type="text" placeholder="Nom du jeu" className="account-offers-form__field" />
        <div className="account-offers-form__game">
          ...
          <input type="text" placeholder="Nb de joueurs" />
        </div>
        <div className="account-offers-form__game">
          <input type="text" placeholder="Durée d'une partie" />
          <input type="text" placeholder="Age minimum" />
        </div>
      ...
      <div className="account-offers-form__container__right">
        ...
        <div className="account-offers-form__block">
          ...
          <input type="text" placeholder="Saisissez un lieu" className="account-offers-form__location" />
