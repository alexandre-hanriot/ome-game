...
const LegalMentions = () => (
  <div className="wrapper legal-mentions">
    <h1 className="legal-mentions__title">Mentions légales</h1>
    <section className="legal-mentions__content">
      ...
      <p>
        ...
        le site, vous reconnaissez avoir pris connaissance de ces conditions et
        les avoir acceptées. Celles-ci pourront êtres modifiées à tout moment
        et sans préavis par la société O'me Game.
        O'me Game ne saurait être tenu pour responsable en aucune manière d’une
        mauvaise utilisation du service.
      </p>
      <h2>Responsable éditorial</h2>
      <p>O'me Game
        par O'me Game
        00 boulevard Antoine TODO
        57000 Metz
        France
        Tél. : + 33 (0)6 00 00 00 00
        Fax : + 33 (0)5 00 00 00 00
        http://www.notre-site.fr
      </p>
      ...
      <p>
        ...
        et sous sa seule responsabilité. En conséquence, Natural net ne saurait
      ...
      <p>
        ...
        Internet ne sauraient engager la responsabilité de Natural net.
      </p>
      <h2>Litiges</h2>
      <p>
        ...
        l'exécution de celles-ci seront de la compétence exclusive des
        tribunaux dont dépend le   siège social de la société Natural net. La
        langue de référence, pour le règlement de contentieux éventuels, est le
        français.
      </p>
      ...
      <p>
        ...
        relative à l'informatique, aux fichiers et aux libertés, le site a fait
      ...
      <p>
        ...
        d’accès, de rectification, de modification et de suppression concernant
        les données qui les concernent personnellement. Ce droit peut être
        exercé par voie postale auprès de Ome game, Boulevard Antoine Gautier
        57000 Metz ou par voie électronique à l’adresse email suivante :
        contact@ome-game.fr.
      </p>
      <p>
        Les informations personnelles collectées ne sont en aucun cas confiées
        à des tiers hormis pour l’éventuelle bonne exécution de la prestation
        commandée par l’internaute.
      </p>
      <h2>Confidentialité</h2>
      <p>
        Vos données personnelles sont confidentielles et ne seront en aucun cas
        communiquées à des tiers hormis pour la bonne exécution de la
        prestation.
      </p>
      ...
      <p>
        ...
        société O'me game à l'exception des marques, logos ou contenus
      ...
      <p>
        ...
        O'me game. Cette représentation ou reproduction, par quelque procédé
        que ce soit, constitue une contrefaçon sanctionnée par les articles L.
        335-2 et suivants du Code de la propriété intellectuelle. Le
      ...
      <p>
        O'me game est identiquement propriétaire des "droits des producteurs de
        bases de données" visés au Livre III, Titre IV, du Code de la Propriété
        Intellectuelle   (loi n° 98-536 du 1er juillet 1998) relative aux
        droits d'auteur et aux bases de données.
      </p>
      <p>
        ...
        www.site-internet-qualite.fr, à condition que ce lien s’ouvre dans une
        nouvelle fenêtre. En particulier un lien vers une sous page (« lien
        profond ») est interdit, ainsi que l’ouverture du présent site au sein
        d’un cadre (« framing »), sauf l'autorisation expresse et préalable de
        O'me game.
      </p>
      <p>
        Pour toute demande d'autorisation ou d'information, veuillez nous
        contacter par email : contact@natural-net.fr. Des conditions
        spécifiques sont prévues pour la presse.
      </p>
      <p>
        Par ailleurs, la mise en forme de ce site a nécessité le recours à des
        sources externes dont nous avons acquis les droits ou dont les droits
        d'utilisation sont ouverts : Seosight, Designed by themefire Developed
        by Crumina​. Les illustrations ont été acquises sur Adobe Stock.
      </p>
      <h2>Hébergeur</h2>
      Aws
      ...
      <p>
        O'me game met en œuvre tous les moyens dont elle dispose, pour assurer
        une information fiable et une mise à jour fiable de ses sites internet.
        Toutefois, des erreurs ou omissions peuvent survenir. L'internaute
        devra donc s'assurer de l'exactitude des informations auprès de O'me
        game, et signaler toutes modifications du site qu'il jugerait utile.
        O'me game n'est en aucun cas responsable de l'utilisation faite de ces
      ...
      <p>
        ...
        des cookies. Il s'agit de petits fichiers textes stockés sur votre disque
        dur afin d'enregistrer des données techniques sur votre navigation.
        Certaines parties de ce site ne peuvent être fonctionnelle sans
        l’acceptation de cookies.
      </p>
      <h2>Liens hypertextes</h2>
      <p>
        Les sites internet de O'me game peuvent offrir des liens vers d’autres
        sites internet ou d’autres ressources disponibles sur Internet.
      </p>
      <p>
        O'me game ne dispose d'aucun moyen pour contrôler les sites en
        connexion avec ses sites internet. O'me game ne répond pas de la
      ...
      <p>
        ...
        O'me game ne peuvent mettre en place un hyperlien en direction de ce
        site sans l'autorisation expresse et préalable de O'me game.
      </p>
      <p>
        Dans l'hypothèse où un utilisateur ou visiteur souhaiterait mettre en
        place un hyperlien en direction d’un des sites internet de O'me game,
        il lui appartiendra d'adresser un email accessible sur le site afin de
        formuler sa demande de mise en place d'un hyperlien. O'me game se
        réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en
        justifier sa décision.
      </p>
      <h2>Recherche</h2>
      <p>
        En outre, le renvoi sur un site internet pour compléter une information
        recherchée ne signifie en aucune façon que O'me game reconnaît ou
        accepte quelque responsabilité quant à la teneur ou à l'utilisation
        dudit site.
      </p>
      ...
      <p>
        ...
        soit pas entaché d'erreurs voire d'éléments de nature destructrice tels
        que virus, trojans, etc....
      </p>
      ...
      <p>
        ...
        s'informer. Si des informations fournies par O'me game apparaissent
        inexactes, il appartiendra au client de procéder lui-même à toutes
        vérifications de la cohérence ou de la vraisemblance des résultats
        obtenus. O'me game ne sera en aucune façon responsable vis à vis des
        tiers de l'utilisation par le client des informations ou de leur
        absence contenues dans ses produits y compris un de ses sites Internet
      </p>
      <h2>Contactez-nous</h2>
      <p>
        O'me game est à votre disposition pour tous vos commentaires ou
        suggestions. Vous pouvez nous écrire en français par courrier
        électronique à : contact@ome-game.fr.
      </p>
    </section>
  </div>
);
