...
export const UPDATE_STATUS_STATE_RESERVATION = 'UPDATE_STATUS_STATE_RESERVATION';
...
export const updateStatusStateReservation = (id) => ({
  type: UPDATE_STATUS_STATE_RESERVATION,
  id,
});
